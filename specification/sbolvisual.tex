...
\packageVersion{Version 2.1-alpha}
\packageVersionDate{November 17, 2018}

% BBF RFC \rfcnum{}: 
\title{Synthetic Biology Open \\Language Visual (SBOL Visual) Version~2.1-alpha}
...
Mike Bissell & \emph{Amyris, Inc., USA}\\
