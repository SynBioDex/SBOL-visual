...
\packageVersion{Version 2.4-alpha}
\packageVersionDate{TBD}

% BBF RFC \rfcnum{}: 
\title{Synthetic Biology Open \\Language Visual (SBOL Visual) Version~2.4-alpha}
...
Jihwan Lee & \emph{Rice University, USA}\\
...
Logan Terry & \emph{Univesity of Utah, USA}\\
