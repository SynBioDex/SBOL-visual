...
\todo[inline]{Update language to SBOL 3.0: equality constraint, and if it crosses a module boundary, then it implies a ComponentReference. Move constraints to their own section}

\todo[inline]{Update: add SBOL3 for the mapping of backbone. Interaction crossing represents a ComponentReference}
