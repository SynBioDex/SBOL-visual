...
\caption{Generic syntax of SBOL visual 2.0:  
...
\item An interaction SHOULD be represented using a glyph defined in \ref{apdx:sym:interaction}.  In this case, the interaction MUST be contained within at least one of the glyph's associated terms.
