...
\item The boundary of module SHOULD should be a rectangle or rounded rectangle. Boundary sides SHOULD be oriented vertically and horizontally.  
	...
	\subfigure[SHOULD NOT]{non-distinct module}
	\caption{}
	\label{exa:moduleA}
	\end{figure}
...
In terms of the SBOL 2 data model, the line represents a \sbol{MapsTo} relationship between a \sbol{FunctionalComponent} in the \sbol{ModuleDefinition} and another \sbol{FunctionalComponent} in the definition of the \sbol{Module}.
	...
	\begin{figure}[h!]
	\centering
	\subfigure[MAY]{legal mapsto}
	\subfigure[SHOULD NOT]{non-distinct mapsto}
	\subfigure[MUST NOT]{incompatible mapsto}
	\caption{}
	\label{exa:moduleB}
	\end{figure}
...
\item Glyphs for sequence features and molecular species MUST NOT intersect with the boundary of a module.
	...
	\begin{figure}[h!]
	\centering
	\subfigure[MUST NOT]{sequence feature and molecular species crossing line}
	\subfigure[MAY]{backbone crossing}
	\subfigure[MAY]{interaction crossing}
	\caption{}
	\label{exa:moduleC}
	\end{figure}
...
% How do we show direction on a port?  We can't, really.
	...
	\begin{figure}[h!]
	\centering
	\subfigure[MAY]{blackbox ports}
	\subfigure[MAY]{ports with mappings}
	\subfigure[MAY]{ports with interactions through}
	\subfigure[SHOULD NOT]{ports with mappings and interactions through}
	\subfigure[MUST NOT]{post with interaction going around it}
	\subfigure[MUST NOT]{port disconnected from associated element}
	\caption{}
	\label{exa:moduleD}
	\end{figure}
