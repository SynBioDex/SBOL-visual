...
\newcommand{\rfcnum}{{\color{red}NNN}}
...
\packageVersionDate{Month Day, 2017}

% BBF RFC \rfcnum{}: 
\title{BBF RFC \rfcnum{}: Synthetic Biology Open \\Language Visual (SBOL Visual) Version~1.1}
...
Augustin Luna & \emph{Harvard Medical School}\\
...
\maketitlepage
\tododeferred{Set date, authors, RFCnum, turn off draft mode}
