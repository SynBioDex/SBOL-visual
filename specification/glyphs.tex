...
For example, a protein coding sequence (CDS) is a sequence feature that may be represented as either using the CDS glyph (Sequence Ontology term SO:0000316) or the Unspecified glyph (Sequence Ontology term SO:0000001).  
