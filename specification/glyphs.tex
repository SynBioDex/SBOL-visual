...
\actionitem{Need to explicitly define bounding boxes}
...
\todoquery{Is alignment plan OK?}
\item A glyph for a \sbol{ComponentInstance} MUST include a horizontal rule for its RECOMMENDED vertical alignment with the \sbol{ComponentDefinition} backbone.
...
\actionitem{example of a glyph specification}
