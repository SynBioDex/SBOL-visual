...
\item An edge with its tail at an interaction node MAY use an \sbol{Interaction} arrow head to indicate an additional \sbol{Interaction} in which this product of the biochemical process has the tail \sbol{role} associated with that type.
